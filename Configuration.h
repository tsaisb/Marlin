...
#define DELTA_DIAGONAL_ROD 228.82

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 196.85 // mm                                             

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 39.11 // mm

// Horizontal offset of the universal joints on the carriages.                        
#define DELTA_CARRIAGE_OFFSET 52.43 // mm
...
#define MANUAL_Z_HOME_POS 345  // For delta: Distance between nozzle and print surface after homing.

#define AUTOLEVEL_GRID 31  // Distance between autolevel Z probing points, should be less than print surface radius/3.
